 ...
 */
public class Converg extends Application {
    ...
    public static void setPulledEvents(ArrayList<Event> pulledEvents) {
        Converg.pulledEvents = pulledEvents;
    }
    ...
    public void makeEventButton(Context context, Event e, RelativeLayout container,
        ...
        RelativeLayout.LayoutParams eventNameAndInfoParams = new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        eventNameAndInfoParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT);

        RelativeLayout.LayoutParams numGoingParams = new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        numGoingParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        ...
        container.addView(eventNameAndInfo, eventNameAndInfoParams);
        container.addView(iv, ivParams);
        container.addView(numGoing, numGoingParams);
