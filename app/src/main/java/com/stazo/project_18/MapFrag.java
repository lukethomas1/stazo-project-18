...
public class MapFrag extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ((Converg) getActivity().getApplication()).setRelevantTime(progress);

                // set the text time
                long rTime = ((Converg) getActivity().getApplication()).getRelevantTime();
                String period = "AM";
                String time = "";
                int DSTOffset = ((new GregorianCalendar()).getTimeZone()).getDSTSavings();
                long hours = TimeUnit.MILLISECONDS.toHours(rTime + DSTOffset +
                        Converg.GMTOffset) % 24;
                if (progress == 0) {
            ...
            GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
    {
                ...
                fb.child("Events").addListenerForSingleValueEvent(
                        new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                //((Converg) getActivity().getApplication()).clearPulledEvents();
                                ...
                                for (DataSnapshot eventSnapshot : dataSnapshot.getChildren()) {
                                    ...
                                    ((Converg) getActivity().getApplication()).addPulledEvent(e);
        ...
        private void displayEvent(Event e) {
            ...
            if (e.getPopularity() < Converg.POP_THRESH1) {
                size = Converg.MARK_SIZE_1;
            }
            else if (e.getPopularity() < Converg.POP_THRESH2) {
                size = Converg.MARK_SIZE_2;
            }
            else {
                size = Converg.MARK_SIZE_3;
            }
            ...
            if (e.happeningSoon()) {
                markerBitmap = Converg.BITMAP_RESIZER(BitmapFactory.decodeResource(getActivity().getResources(),
