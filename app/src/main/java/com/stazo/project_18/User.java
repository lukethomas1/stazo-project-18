...
public class User {
    ...
    public User(HashMap<String, Object> userMap) {
        ...
        this.numStrikes = (int) userMap.get("numStrikes");
    ...
    public boolean reportEvent(String event_id, Firebase fb) {
        ...
        // increment reports
        fb.child("Events").child(event_id).child("reporters").runTransaction(new Transaction.Handler() {
            @Override
            public Transaction.Result doTransaction(MutableData currentData) {
                // if I'm the first reporter
                if (currentData.getValue() == null) {
                    ArrayList<String> meList = new ArrayList<String>();
                    meList.add(ID);
                    currentData.setValue(meList);
                }
                // if I haven't already reported it
                else if (!((ArrayList<String>) currentData.getValue()).contains(ID)) {
                    ArrayList<String> newList = (ArrayList<String>) currentData.getValue();
                    newList.add(ID);
    ...
    public int getNumStrikes() {return this.numStrikes;}
    ...
    public void setNumStrikes(int n) {this.numStrikes = n;}
