...
public class NotificationHandler {
    ...
    public void generateNotifications(Context context) {
        ...
        nce.pushToFirebase(Converg.getFB(), usersWhoCare);
        nfe.pushToFirebase(Converg.getFB(), usersWhoCare);
        nnf.pushToFirebase(Converg.getFB(), usersWhoCare);
        nje.pushToFirebase(Converg.getFB(), usersWhoCare);
    ...
    public void setToViewed(final Notification notif) {
        Converg.getFB().child("NotifDatabase").child("1184188798300386").
