...
public class LocSelectAct extends FragmentActivity
    ...
    public void goToMap(View view) {
        ...
        if (eventToInit.getLocation() == null) {
            ...
            /*eventToInit.pushToFirebase(((Converg) getApplication()).getFB(),
                    Converg.me.getName(), Converg.me.getUserFollowers());*/
            eventToInit.pushToFirebase(((Converg) getApplication()).getFB(),
                    Converg.me.getName(), new ArrayList<String>(Converg.me.getFriends().keySet()));
            ((Converg) getApplication()).addPulledEvent(eventToInit);
    ...
    public void pushMainImage(Uri imageFile) {
        ...
        StorageReference storageRef = ((Converg) getApplication()).getFBStorage();
...
//        });
        ...
        StorageReference eventImageStorage = storageRef.child("EventImagesDatabase/" +
                eventToInit.getEvent_id() + "/" + ((Converg) getApplication()).getMe().getID() + "_" + timeStamp+ ".jpg");
        StorageMetadata metta = new StorageMetadata.Builder()
                ...
                .setCustomMetadata("User", ((Converg) getApplication()).getMe().getID())
                .build();
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                ((Converg) getApplication()).getFB().child("ImagesDatabase").child("EventImages").
    ...
    private void setFlag(LatLng point){
        ...
        Bitmap markerBitmap = Converg.BITMAP_RESIZER(BitmapFactory.decodeResource(getResources(),
