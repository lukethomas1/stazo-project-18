...
public class LocSelectAct extends FragmentActivity
    ...
    public void goToMap(View view) {
        ...
        if (eventToInit.getLocation() == null) {
            ...
            /*eventToInit.pushToFirebase(((Campus) getApplication()).getFB(),
                    Campus.me.getName(), Campus.me.getUserFollowers());*/
            eventToInit.pushToFirebase(((Campus) getApplication()).getFB(),
                    Campus.me.getName(), new ArrayList<String>(Campus.me.getFriends().keySet()));
            ((Campus) getApplication()).addPulledEvent(eventToInit);
    ...
    public void pushMainImage(Uri imageFile) {
        ...
        StorageReference storageRef = ((Campus) getApplication()).getFBStorage();
...
//        });
        ...
        StorageReference eventImageStorage = storageRef.child("EventImagesDatabase/" +
                eventToInit.getEvent_id() + "/" + ((Campus) getApplication()).getMe().getID() + "_" + timeStamp+ ".jpg");
        StorageMetadata metta = new StorageMetadata.Builder()
                ...
                .setCustomMetadata("User", ((Campus) getApplication()).getMe().getID())
                .build();
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                ((Campus) getApplication()).getFB().child("ImagesDatabase").child("EventImages").
    ...
    private void setFlag(LatLng point){
        ...
        Bitmap markerBitmap = Campus.BITMAP_RESIZER(BitmapFactory.decodeResource(getResources(),
