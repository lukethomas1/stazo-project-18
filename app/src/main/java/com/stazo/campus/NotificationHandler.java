...
public class NotificationHandler {
    ...
    public void generateNotifications(Context context) {
        ...
        nce.pushToFirebase(Campus.getFB(), usersWhoCare);
        nfe.pushToFirebase(Campus.getFB(), usersWhoCare);
        nnf.pushToFirebase(Campus.getFB(), usersWhoCare);
        nje.pushToFirebase(Campus.getFB(), usersWhoCare);
    ...
    public void setToViewed(final Notification notif) {
        Campus.getFB().child("NotifDatabase").child("1184188798300386").
