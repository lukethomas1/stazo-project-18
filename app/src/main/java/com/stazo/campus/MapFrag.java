...
public class MapFrag extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ((Campus) getActivity().getApplication()).setRelevantTime(progress);

                // set the text time
                long rTime = ((Campus) getActivity().getApplication()).getRelevantTime();
                String period = "AM";
                String time = "";
            ...
            GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
    {
                ...
                fb.child("Events").addListenerForSingleValueEvent(
                        new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                //((Campus) getActivity().getApplication()).clearPulledEvents();
                                ...
                                for (DataSnapshot eventSnapshot : dataSnapshot.getChildren()) {
                                    ...
                                    ((Campus) getActivity().getApplication()).addPulledEvent(e);
        ...
        private void displayEvent(Event e) {
            ...
            if (e.getPopularity() < Campus.POP_THRESH1) {
                size = Campus.MARK_SIZE_1;
            }
            else if (e.getPopularity() < Campus.POP_THRESH2) {
                size = Campus.MARK_SIZE_2;
            }
            else {
                size = Campus.MARK_SIZE_3;
            }
            ...
            if (e.happeningSoon()) {
                markerBitmap = Campus.BITMAP_RESIZER(BitmapFactory.decodeResource(getActivity().getResources(),
