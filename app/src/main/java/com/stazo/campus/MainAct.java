...
public class MainAct extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int index = 0; index < Event.types.length; index++) {
            Campus.filteredCategories.add(new Integer(index));
        }
        ...
        //Campus.filteredCategories.add(-1);
    ...
    private void addEventTodayNotifications() {
        for (String eventID: ((Campus) getApplication()).getMe().getAttendingEvents()) {
            ((Campus) getApplication()).getFB().child("Events").
    ...
    private void checkAllNotificationsViewed() {
        ...
        User currentUser = ((Campus) getApplication()).getMe();

        Campus.getFB().child("NotifDatabase").
        ...
        if (searchView != null) {
            ...
            queryTextListener = new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    /*((Campus) getApplication()).setRelevantText(newText);
                    // filter MapFrag
...
//        profileFrag.setUser_ID(((Campus)this.getApplication()).getMe().getID());
...
//    }
    ...
    public void editBio(View view) {
        ...
        input.setText(Campus.me.getBio());
    ...
    public void goToFacebookProfile(View v) {
        Intent facebookIntent = getOpenFacebookIntent(this, Campus.me.getID());
